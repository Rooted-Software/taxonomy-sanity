  ...
  return (
    <DashboardShell>
      ...
      <Card className="m-0 p-0">
        ...
        <CardFooter><a href='/step1' className='relative inline-flex h-9 items-center rounded-full border border-transparent bg-accent-1 px-4 py-2 text-sm font-medium text-dark hover:bg-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2'>
