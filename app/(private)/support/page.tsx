      ...
      <div className="container mt-4 grid grid-cols-1 gap-4 pt-4 lg:grid-cols-1">
        <div className="p-4 text-lg font-semibold leading-none tracking-tight">
          ...
          <p className="pt-4 font-normal">
            We currently are offering self service support through our
            documentation or email support through the form below. In addition,
            if you are one of our enterprise customers, you can reach out to
            your account manager for additional support.
            <br />
            <br />
            <a className="underline" href="/docs/overview">
              View DonorSync Documentation
            </a>
          </p>
        </div>
      </div>
