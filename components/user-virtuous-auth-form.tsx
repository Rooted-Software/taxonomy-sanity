          ...
          <>
            ...
            <div className="col-span-2 grid">
              ...
              <input
                id="twoFactor"
                placeholder="123456"
                className="my-1 h-9 w-full rounded-full border border-slate-300 px-3 py-2 text-sm text-slate-500 placeholder:text-slate-500 hover:border-slate-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1"
                type="text"
                autoCapitalize="none"
                autoCorrect="off"
                disabled={isLoading}
          ...
          <div className="mb-3 space-y-1">
            <div>
              ...
              <input
                ...
                className="my-1 h-9 w-full rounded-full border border-slate-300 px-3 py-2 text-sm text-black placeholder:text-slate-400 hover:border-slate-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:ring-offset-1"
                type="email"
                autoCapitalize="none"
                autoComplete="email"
                autoCorrect="off"
